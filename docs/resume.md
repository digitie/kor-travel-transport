...
- 2026-09-26 여객선 운항시간표의 PostgreSQL 저장 전환을 n150에 적용했다. 실행 코드
  ...
  빈 응답과 미수집은 구별해야 한다. 다음 작업은 live E2E(첫 실행 277/278)가 찾은
  로그아웃 캐시 경합 수정의 재배포·CI·전체 E2E·적대 리뷰 후 PR #40 머지다. 전국 10일
  범위의 누락 수와 수집 실행 결과도 계속 확인하되, 호출 제한을 낮춰 초기 수집을 가속하지 않는다.
